...
public class GlobalExceptionHandler implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        if (ex instanceof AutenticacionException autenticacionException) {
            status = HttpStatus.valueOf(autenticacionException.getCodigoEstado());
            error.put(PROPIEDAD_ERROR, autenticacionException.getError());
            error.put(PROPIEDAD_MENSAJE, autenticacionException.getMessage());
            error.put(PROPIEDAD_ESTADO, autenticacionException.getCodigoEstado());
